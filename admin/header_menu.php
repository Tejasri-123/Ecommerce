    ...
    <div class="collapse navbar-collapse" id="mynavbar">
      <ul class="nav navbar-nav">
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu">
            <a href="men.php" class="dropdown-item">Men</a>
            <a href="women.php" class="dropdown-item">Women</a>
            <a href="kids.php" class="dropdown-item">Kids</a>
            <a href="accessories.php" class="dropdown-item">Accessories</a>
          </div>
      ...
      ?>
        <ul class="nav navbar-nav ml-auto">
          ...
          <li class="nav-item"><a class="nav-link " data-placement="bottom" data-toggle="popover" data-trigger="hover" data-content="<?php echo $_SESSION['name'] ?>"><i class="fa fa-user-circle "></i></a></li>
        </ul>
      <?php
      } else {
      ?>
