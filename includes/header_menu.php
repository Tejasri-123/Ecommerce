...
<nav class="navbar fixed-top navbar-expand-sm navbar-dark" style=" background-color:rgba(0, 0, 0, 0.7);">
  <div class="container">
    <a href="index.php" class="navbar-brand" style="font-size:30px;font-family: 'Delius Swash Caps';">FashionFuse</a>
      ...
      <ul class="nav navbar-nav">
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu">
            <a href="products.php#products" class="dropdown-item">Men</a>
            <a href="products.php#products" class="dropdown-item">Women</a>
            <a href="products.php#products" class="dropdown-item">Kids</a>
            <a href="products.php#products" class="dropdown-item">Accessories</a>
          </div>

        </li>
        <li class="nav-item"><a href="index.php#aboutus" class="nav-link">About US</a></li>
      ...
      <div class="modal-body">
        <form action="signup_script.php" method="post">
          ...
          <div class="form-group">
            ...
            <input type="mobile" class="form-control" id="pwd" name="mobile" placeholder="mobile" required>
          </div>
